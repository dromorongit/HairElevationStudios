...
// Admin login route - must come before static files
...
// Serve static files (frontend) - Serve from project root directory, but exclude admin routes
app.use(express_1.default.static(path_1.default.join(__dirname, '..')));
// Serve uploaded files
app.use('/uploads', express_1.default.static(path_1.default.join(__dirname, '../uploads')));
// Specific routes for logos to ensure they load correctly
app.get('/HESLOGO.PNG', (req, res) => {
    const logoPath = path_1.default.join(__dirname, '..', 'HESLOGO.PNG');
...
app.get('/pricelist.jpg', (req, res) => {
    res.sendFile(path_1.default.join(__dirname, '..', 'pricelist.jpg'));
});
// Health check
...
// Connect to MongoDB
mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/hairelevation')
    .then(() => {
