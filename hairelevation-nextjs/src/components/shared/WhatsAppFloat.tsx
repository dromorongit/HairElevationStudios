  ...
  return (
    <div className="whatsapp-float fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        />
        {/* Button */}
        <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-b from-[#25D366] via-[#20B954] to-[#128C7E] shadow-[0_10px_30px_rgba(37,211,102,0.5)] hover:shadow-[0_12px_35px_rgba(37,211,102,0.6)] transition-shadow">
          <svg
            width="30"
            height="30"
            viewBox="0 0 24 24"
