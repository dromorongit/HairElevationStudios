...
export function Button({
  ...
  const variantStyles = {
    primary:
      "bg-gradient-to-r from-[#C8A97E] via-[#B8956A] to-[#A67C52] text-[#3B2A23] shadow-[0_6px_20px_rgba(200,169,126,0.4)] hover:shadow-[0_8px_25px_rgba(200,169,126,0.5)]",
    secondary:
      "bg-[#3B2A23] text-[#F5EFE6] hover:bg-[#2A1F1A]",
    whatsapp:
      "bg-gradient-to-r from-[#25D366] via-[#20B954] to-[#128C7E] text-white shadow-[0_10px_30px_rgba(37,211,102,0.5)] hover:shadow-[0_12px_35px_rgba(37,211,102,0.6)]",
    outline:
