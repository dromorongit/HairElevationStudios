...
<div className="w-full">
              ...
              <a
                ...
                className="px-4 py-2 rounded-full text-xs font-medium uppercase tracking-widest transition-all duration-300 inline-flex items-center justify-center bg-[var(--gradient-gold)] text-[var(--bg-primary)] shadow-[0_8px_32px_rgba(0,0,0,0.4)] hover:shadow-[0_0_20px_rgba(200,169,126,0.2)]"
              >
                Join Our Channel
              </a>
